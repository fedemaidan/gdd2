...
namespace PagoElectronico.ABM_Cliente
{
    public partial class UpdateCliente : Form
    {
        ...
        private void btn_accept_Click(object sender, EventArgs e)
        {
            ...
            int resultado = home2.updateCliente(txt_nombre.Text, txt_apellido.Text, txt_mail.Text, txt_dni.Text, cb_docs.Text, txt_pais.Text, txt_calle.Text, txt_altura.Text, txt_piso.Text, txt_depto.Text, txt_localidad.Text, txt_nacionalidad.Text,Convert.ToDateTime(  textBox_fecha.Text ), this.username);
